...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210901_positiveegy_8ba7484b8dc22e898511_20210901085542_archive.zip';
	const ARCHIVE_SIZE		 = '179843578';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8ba7484-01085542';
    const SECONDARY_PACKAGE_HASH = 'dd8c2b4-01085542';
	const VERSION			 = '1.4.2';
